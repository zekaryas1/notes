...
date modified: Tuesday, August 8th 2023, 1:03:51 pm
title: Volumes
---
...
- **It allows the host to share its own filesystem with the container**, which can be made read-only or read-write.
