...
date modified: Sunday, July 6th 2025, 6:00:05 pm
---
...
- Source of Prompt injection:
	- Prompt injection can be started by an ill-intentioned user or by the source you are using, such as the database or RAG source.
