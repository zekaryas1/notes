---
title: AGENTS with ADK
date created: Friday, March 21st 2025, 4:52:19 pm
date modified: Monday, May 26th 2025, 4:17:15 pm
---

# AGENTS with ADK

- **Definition**: In ADK, an _agent_ is a self-contained execution unit designed to operate autonomously to achieve specific goals.
- **Capabilities**:
...
- **Optional Parameters**:
    ...
    - instruction: Defines the agent’s goals, tool usage, and output format.
        ...
        - Its best to check and follow the models prompt engineering guidance, different model providers provide their prompt engineering best practices.
